...
class Screenwriter(object):
    ...
    def build_scene(self, scene_number):
        if scene_number != 1:
            return
        protagonist = Casting.create_protagonist(Coordinate(600, 50, 0))
        antagonist = Casting.create_antagonist(Coordinate(-500, 150, 0))
        ...
        sc.stage_directions.append(antagonist.walk_right(duration= 1000))
        return sc